        ...
        <div class="row">
          <div class="col-lg-6" data-aos="fade-up">
            ...
            <div class="resume-item pb-0">
              <h4>Hana Noorudheen</h4>
              <p><em>I am a 4th year B.tech Computer Science Engineering Student.</em></p>
              <ul>
                <li>Aluva,Ernakulam ,Kerala-683110</li>
                <li>+91-8086876572</li>
                <li>hananoorudheen721@gmail.com</li>
              </ul>
            </div>
      ...
      <div class="resume-item">
          ...
          <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item">
              ...
              <h5>2015-2016</h5>
              <p><em>International Indian School-Saudi Arabia </em></p>
              <ul>
                <li>Cumulative GPA: 10/10</li>
...
Expected to graduate in 2023.</p>
            </div>
            <div className="resume-item">
